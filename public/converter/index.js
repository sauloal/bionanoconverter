      ...
      parser.prototype.add_file = function(file) {
              ...
              self.parse_q_cmap( self, function() {
                self.parse_xmap( self, function() {
                  if ( 'smap' in self.files ) {
                    self.parse_smap(self, self.report);
                  } else {
                    self.report(self);
                  }
                });
      ...
      parser.prototype.report         = function(self) {
        self.report_r_cmap(self);
        self.report_q_cmap(self);
        self.report_xmap(self);
        if ( 'smap' in self.files ) {
          self.report_scmap(self);
        }
      }
      
      
      //https://genome.ucsc.edu/FAQ/FAQformat.html#format1
      parser.prototype.report_r_cmap  = function(self) {
        ...
        self.create_file(self, filename + '.bed', outdata_bed.join("\n"));
        
        console.log('outdata_wig', outdata_wig);
        self.create_file(self, filename + '.wig', outdata_wig.join("\n"));
      }
      
      parser.prototype.create_file    = function(self, filename, text) {
      ...
      parser.prototype.report_q_cmap  = function(self) {
        var ldata       = self.data['r_cmap' ];
        var header      = ldata['header'     ]; // []
        var data        = ldata['data'       ]; // {}
        var chr_size    = ldata['chr_size'   ]; // {}
      ...
      parser.prototype.report_xmap    = function(self) {
      }
      
      parser.prototype.report_smap    = function(self) {
      }

      
      
      
      parser.prototype.read_file      = function(file, clbk) {
        /*
        //http://www.html5rocks.com/en/tutorials/file/dndfiles/
      ...
      parser.prototype.parse_header   = function(ldata) {
      ...
      parser.prototype.parse_key_file = function(self, clbk) { 
      ...
      parser.prototype.parse_r_cmap   = function(self, clbk) { 
      ...
      parser.prototype.parse_q_cmap   = function(self, clbk) { 
      ...
      parser.prototype.parse_xmap     = function(self, clbk) { 
      ...
      parser.prototype.parse_smap     = function(self, clbk) { 
